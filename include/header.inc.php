...
$wishlist_count=mysqli_num_rows(mysqli_query($con,"select product.name,product.image,product.price,product.shipping_price,wishlist.id from product,wishlist where wishlist.product_id=product.id and wishlist.user_id='$uid'"));
}
...
<?php
$cat_id=$list['id'];
$query="select * from sub_categories where status='1' and categories_id='$cat_id'";
$sub_cat_res=mysqli_query($con,$query);
...
<ul class="navbar-nav mr-auto navbar-rghit">
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
مرحبا <?php echo $_SESSION['USER_NAME']?>
</a>
<div class="dropdown-menu" aria-labelledby="navbarDropdown">
<a class="dropdown-item" href="my_order.php">الطلبات</a><br>
...
echo '<a href="login.php" class="mr15">تسجيل</a>';
}
?>
...
<input placeholder="ابحث هنا " type="text" name="str">
<button type="بحث"></button>
</form>
