			...
			<span class="breadcrumb-item active">الملف الشخصي</span>
			</nav>
			</div>
			</div>
			</div>
			...
			<h2 class="title__line--6">الملف الشخصي</h2>
			</div>
			</div>
			<div class="col-xs-12">
			...
			<input type="text" name="name" id="name" placeholder="الاسم*" style="width:100%" value="<?php echo $_SESSION['USER_NAME']?>">
			</div>
			<span class="field_error" id="name_error"></span>
			</div>

			<div class="contact-btn">
			<button type="button" class="fv-btn" onclick="update_profile()" id="btn_submit">تحديث</button>
			...
			<div class="col-xs-12">
			<div class="contact-title">
			<h2 class="title__line--6">تغير كلمة السر</h2>
			</div>
			</div>
			<div class="col-xs-12">
			...
			<div class="contact-btn">
			<button type="button" class="fv-btn" onclick="update_password()" id="btn_update_password">تحديث</button>
			...
			jQuery('#btn_submit').html('الرجاء الانتظار...');
